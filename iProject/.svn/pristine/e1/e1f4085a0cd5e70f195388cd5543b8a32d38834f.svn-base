...
function BtnDelete(){
	...
	if(re){		
		$("#wform").attr("action","reference_Delete").submit();
		return;
	}else{
		return;
	}
        ...
        <div class="contents_wrap">
            ...
            <div class="contents">
                ...
                <table width="764" cellpadding="0" cellspacing="0" class="bbs_view" >
                    ...
                    <tr>
                    	<th>제목</th>
                    	<td>${referenceVO.subject}</td>
                    	<th>작성자</th>
                    	<td>${referenceVO.writer}</td>
                	</tr>
               		<tr>
                    	<th>등록일</th>
                    	<td>${referenceVO.regdate}</td>
                    	<th>조회</th>
                    	<td>${referenceVO.cnt}</td>
                	</tr>
                	<tr>
                    	<c:choose>
                		<c:when test="${referenceVO.isfile=='Y'}">
                    	<th>첨부파일</th>
                    	<td colspan="3"><a href="#">${referenceVO.filename}</a></td>
                    	</c:when>
                    	<c:otherwise>
                    	<th>첨부파일</th>
                    ...
                    <tr>
                    	<th>내용</th>
                    	<td colspan="3"><pre>${referenceVO.content}</pre></td>
                    </tr>
                </table>
                ...
                <a href="/referenceList"><img src="./images/common/btn_list.gif" alt="목록"></a>
                </p>
