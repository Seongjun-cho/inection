  ...
  <div class="subContents bg0101">
    ...
    <div class="contents_wrap">
      <div class="local_wrap">
        <ul>
          <li class="local"><img src="./images/company/local03.png" alt="HOME>회사소개>기술연혁"></li>
          <li class="title"><img src="./images/company/subtitle03.png" alt="기술연혁"></li>
        </ul>
      </div>
      <div class="contents"> 
        <%--//내용시작--%>
        ...
        <dl class="history2">
          ...
          <dd>
            <ul>
              ...
              <li><span>9월</span>(주)아이넥션소프트 홈페이지 리뉴얼</li>
        ...
        <dl class="history2">
          ...
          <dd>
            <ul>
              ...
              <li><span>4월</span>생명 NPAS 소스코드 분석툴 Fortify 구축</li>
